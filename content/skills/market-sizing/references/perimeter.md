...
Riferimento della skill `market-sizing`. Leggi questo file prima delle domande iniziali, prima di eseguire il metodo ATECO oppure gli Step 0–2 e il Checkpoint 1 del percorso semantico. Le capacità Syrto citate qui sono mappate agli strumenti nella capability map (`{{ROOT}}/shared/syrto-reference.md`).
